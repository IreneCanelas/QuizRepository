...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20-Maio-2020 às 02:31
...
(1, '1', 'Resolva: 194 - 57 + 112 - 89 =', '56', '160', '174', '74', '160', '74', 'Matemática'),
...
(5, '5', 'Se seis pessoas comem 6 chocolates em 6 minutos, quantas pessoas comerão 80 chocolates em 48 minutos?', '17', '14', '10', 'Nenhuma das opções', '10', '10', 'Matemática'),
...
(7, '7', 'Um elevador suporta 600 Kg, quantas caixas de 48 Kg se pode levar de cada vez?', '13', '12', '10', '6', '12', '6', 'Matemática'),
(8, '8', 'Perguntado pela idade, o Pedro responde: \"Daqui a 30 anos terei três vezes a idade de agora\". \r\nQual é a idade do Pedro?', '16', '10', '15', '13', '15', '10', 'Matemática'),
(9, '9', 'Que simbolo representa o Numéro de Neper?', 'e', 'E', '%', 'Nenhuma das opções', 'e', '%', 'Matemática'),
(10, '10', 'O número 0.333... pode ser representado pela fração:', '3/4', '5/6', '4/12', '7/9', '4/12', '7/9', 'Matemática'),
...
(19, '9', 'Em média, quantas pesquisas totalmente novas são feitas no Google?', '450 milhões', '1 bilhão ', '280 milhões', '00 milhões', '450 milhões', '00 milhões', 'Tecnologia'),
...
(23, '3', 'Clorofila é um(a)...', 'produto usado para limpeza pesada', 'produto usado para higienizar piscinas', 'pigmento existente nos vegetais', 'substância usada na limpeza dentária', 'pigmento existente nos vegetais', 'substância usada na limpeza dentária', 'Biologia'),
